...
ax.scatter(東北新幹線.ekiData2[:,0],東北新幹線.ekiData2[:,1], c="b", s=10)
ax.scatter(中央線.ekiData2[:,0],中央線.ekiData2[:,1], c="b", s=10)
ax.plot(東北線.curve_c[0],東北線.curve_c[1],c="c")
ax.plot(東北新幹線.curve_c[0],東北新幹線.curve_c[1],c="c")
ax.plot(中央線.curve_c[0],中央線.curve_c[1],c="c")
plt.show()
...
plt.show()
>>>>>>> 741e120f539bea784fdedb407e71977757de3069
