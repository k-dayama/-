...
ax.scatter(東海道新幹線.ekiData2[:,0],東海道新幹線.ekiData2[:,1], c="r", s=10)
ax.scatter(鋼索線.ekiData2[:,0],鋼索線.ekiData2[:,1], c="y", s=10)
...
ax.plot(東海道新幹線.curve_c[0],東海道新幹線.curve_c[1],c="r")
ax.plot(鋼索線.curve_c[0],鋼索線.curve_c[1],c="y")
plt.show()
